<%-- 
    Document   : changeRooms
    Created on : Jan 15, 2021, 4:08:55 PM
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
      ...
      <% 
          List<Room> rooms = (List<Room>) request.getAttribute("CHANGED_ROOMS"); 
    ...
    <div class="tab-content">
       ...
       <div id="table">
        ...
        <thead>
            ...
            <tr>
                ...
                <td><%= rooms.get(i).isBooked() %></td>
                 <td>
                 <button type="button" onClick="reserveRoom(<%= rooms.get(i).getId()%>)" class="btn btn-primary select">Select</button>
                   <button type="button" onClick="removeRoom(<%= rooms.get(i).getId()%>)" class="btn btn-danger remove">Remove</button>
                </td>
            </tr>
             <%  } %>
        </thead>
        ...
        <form id="reservationForm" action="CustomerControllerServlet" method="POST">
            ...
            <input type="hidden" id="command" name="command" value="confirmChangeReservation">
...
//                document.getElementById("reservedRooms").innerHTML += room_id;
      ...
      function removeRoom(room_id)
      {
        ...
        function reserve()
        {
           ...
           $('#newRoomId').val(reservedRoomsString);
